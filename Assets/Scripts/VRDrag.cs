...
[RequireComponent(typeof(Rigidbody))]
  public class VRDrag : MonoBehaviour
  {
    ...
    private Vector3 m_lastScreenPoint;
    private Vector3 m_offset;

    public float inertia_force = 5;
    ...
    void OnMouseDrag()
    {
      m_lastScreenPoint = GetMousePosWithScreenZ(m_screenPoint.z);
    }

    void OnMouseUp()
    {
      m_currentCamera = null;
      Debug.Log(GetMousePosWithScreenZ(m_screenPoint.z) - m_lastScreenPoint);
      m_rigidbody.AddForce((GetMousePosWithScreenZ(m_screenPoint.z) - m_lastScreenPoint) * inertia_force);
